(define (domain vincentland)
	...
	(:action damage
		...
		:effect (and (damaged ?i) (increase (total-cost) 1)))
	...
	(:action defend 
		...
		:effect (and (defended ?todefend) (increase (total-cost) 1)))
	...
	(:action report
		...
		:effect (and (has ?char ?info) (increase (total-cost) 1)))
	...
	(:action take
		...
		:effect (and (has ?p ?i2) (not (has ?char ?i2)) (increase (total-cost) 1)))
